...
-- Only admins can insert users (registration will be handled separately)
...
CREATE POLICY "Everyone can view active quizzes" ON quizzes
...
INSERT INTO users (id, username, email, role) VALUES 
  ('00000000-0000-0000-0000-000000000001', 'admin', 'admin@quiz.com', 'admin'),
  ('00000000-0000-0000-0000-000000000002', 'student1', 'student1@quiz.com', 'student');
